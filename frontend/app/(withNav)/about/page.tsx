    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-stone-50">
        <div className="container mx-auto px-4 max-w-5xl space-y-12">
          ...
          {/* Family legacy */}
          <div className="rounded-3xl bg-linear-to-br from-green-50 to-emerald-50 border border-green-100 p-6 sm:p-8 md:p-10 space-y-5">
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-green-900">
            ...
            <p className="text-base sm:text-lg text-stone-800 leading-relaxed border-t border-green-200 pt-4 mt-2">
