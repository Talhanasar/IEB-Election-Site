...
function SuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-green-50 via-stone-50 to-green-50/30 py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-green-100">
            ...
            <div className="bg-linear-to-r from-green-800 to-green-900 px-8 py-12 text-center relative overflow-hidden">
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-100 text-green-900 text-sm font-semibold mb-6">
                ...
                <p className="text-lg text-stone-700 leading-relaxed mb-6">
                  {isContact ? (
                    <>
                      ...
                      <span className="font-semibold text-green-800">24-48 hours</span>.
                    </>
                  ) : (
                    <>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  className="flex-1 bg-green-800 hover:bg-green-900 text-white h-14 text-lg rounded-full shadow-lg shadow-green-900/20"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="flex-1 border-green-800 text-green-900 hover:bg-green-50 h-14 text-lg rounded-full"
                >
                  <Link href={formPath}>
